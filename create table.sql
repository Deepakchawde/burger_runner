...
-- createing the table burger_name in the database
...
insert into burger_name(burger_id, burger_name) values (1,"Meatlover");
insert into burger_name(burger_id, burger_name) values (2,"Vegeterian");


-- creating  the table burger runner 
...
insert into burger_runner(runner_id,registration_date) values (4,'2021-01-015');
...
drop table burger_runner_orders
